...
// show link project - hover
const links 					= document.querySelectorAll('#slide__content-link'),
			slideContentImg = document.querySelector('#slide__content-img');

console.log(links);

links.forEach((link, index) => {
	link.addEventListener('mouseover', () => {
		slideContentImg.classList.add(`show${index}`)
	})

	link.addEventListener('mouseout', () => {
		slideContentImg.classList.remove(`show${index}`)
	})
})

//	show menu 
const menuBtn 	= document.querySelector('.menu .menu-button'),
			modalBtn 	= document.querySelector('.menu-links .menu-link-modal'),
			menuLink = document.querySelector('.menu-links'),
			menuLinkBg = document.querySelector('.menu-links-bg'),
			menuLinks = document.querySelectorAll('.menu-links .menu-link');
	...
	menuLinks.forEach((link, index) => {
		link.addEventListener('click', () => {
			...
			if ( current === index || isAnimating )  {
				menuLink.classList.add('unshow-item')
				menuLinkBg.classList.add('unshow-item')
			};
			menuLink.classList.add('unshow-item')
			menuLinkBg.classList.add('unshow-item')
				navigate(index);
...
menuBtn.addEventListener('click', () => {
	menuLink.classList.remove('unshow-item')
	menuLinkBg.classList.remove('unshow-item')
})
